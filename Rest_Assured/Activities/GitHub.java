...
public class GitHub {
	...
	public void setUp() {
		...
		resspec = new RequestSpecBuilder()
				...
				.addHeader("Authorization", "token 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")
				.build();
	}
	...
	public void postSSH() {
		ssh = """
				{
				    "title": "TestAPIKey",
				    "key": "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAICfJDEGrN9M2SdsA1eArVnm94/sgHlbtzhowch+k6Esl"
				}
